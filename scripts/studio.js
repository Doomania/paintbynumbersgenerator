 ...
 */
define("lib/colordistance", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.nearestPaletteIndex = exports.ciede2000 = void 0;
     ...
     */
    function nearestPaletteIndex(lab, palette, excluded) {
        let best = -1;
        ...
        if (best === -1) {
            return nearestPaletteIndex(lab, palette);
        }
        return best;
    }
    exports.nearestPaletteIndex = nearestPaletteIndex;
});
define("lib/clustering", ["require", "exports", "lib/colordistance"], function (require, exports, colordistance_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class KMeans {
         ...
         */
        constructor(points, k, random, centroids = null, palette = null) {
            this.points = points;
            this.k = k;
            this.random = random;
         ...
         */
        initCentroidsFromPalette(palette) {
            const coverage = new Array(palette.length).fill(0);
            for (const p of this.points) {
                const idx = (0, colordistance_1.nearestPaletteIndex)(p.values, palette);
            ...
            for (const p of this.points) {
                ...
                for (let k = 0; k < this.k; k++) {
                    ...
                    const dist = this.palette !== null
                        ? (0, colordistance_1.ciede2000)(this.centroids[k].values, p.values)
            ...
            for (let k = 0; k < this.pointsPerCategory.length; k++) {
                ...
                if (cat.length > 0) {
                    ...
                    if (this.palette !== null) {
                        const idx = (0, colordistance_1.nearestPaletteIndex)(avg.values, this.palette, claimed);
                        claimed.add(idx);
                    ...
                    if (worstPoint !== null) {
                        const idx = (0, colordistance_1.nearestPaletteIndex)(worstPoint.values, this.palette, claimed);
                        if (!claimed.has(idx)) {
                            claimed.add(idx);
    ...
    KMeans.MAX_RESEED_ITERATIONS = 15;
});
            ...
            return __awaiter(this, arguments, void 0, function* (imgData, outputImgData, ctx, settings, onUpdate = null) {
                ...
                if (settings.kMeansColorRestrictions.length > 0) {
                    ...
                    for (const c of settings.kMeansColorRestrictions) {
                        const rgb = (typeof c === "string") ? settings.colorAliases[c] : c;
                        ...
                        if (seen[key]) {
                            continue;
                        } // de-dupe identical swatches
                        seen[key] = true;
                        paletteLab.push((0, colorconversion_1.rgb2lab)(rgb));
                    }
                ...
                const kmeans = new clustering_1.KMeans(vectors, settings.kMeansNrOfClusters, random, null, paletteLab);
